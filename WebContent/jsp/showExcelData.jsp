...
<table border="1" cellspacing="0" style="border: thin;width:793.8px;height:1122.66px">
	<tr>
		<td colspan="9"  align="center" style="font-size:28px;font-family:黑体">考生放弃考试退费申请确认单</td>
	</tr>
	<%
	...
	<tr>
		...
		<td  colspan="8"  align="center"><%=USER.class.getMethod("getKHH").invoke(list.get(0)) %></td>
	</tr>	
	<tr>
		<td  align="center">卡号 </td>
		<td colspan="8"   align="center"><%=USER.class.getMethod("getYHKH").invoke(list.get(0)) %></td>
	</tr>	
	<tr>
		<td  align="center">持卡人 </td>
		<td colspan="8"  align="center"><%=USER.class.getMethod("getKSXM").invoke(list.get(0)) %></td>
	</tr>
	<tr>
		<td colspan="9" align="center">我愿放弃该考试，并确认退费信息无误，现申请退费。  &nbsp; &nbsp; &nbsp;<br>&nbsp; &nbsp; &nbsp;申请人签名：<br>&nbsp; &nbsp; &nbsp;2015年  &nbsp; &nbsp;月    &nbsp; &nbsp; 日 </td>
	</tr>
</table>
</body>
</html>